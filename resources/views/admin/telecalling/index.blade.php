...
@section('title', 'Admin | All Telecallings')
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            ...
            <div class="float-right">
                <a href="{{route('admin.telecalling.create')}}" class="btn btn-primary btn-sm">Create Telecalling</a>
            </div>
            </div>
            <div class="card-body">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{route("admin.telecalling.distribute")}}" method="POST">
                                    @csrf
                            ...
                            <td>
                                ...
                                @else
                                <a href="{{route('admin.telecalling.applications',$telecalling->id)}}">View Applications</a>
                                @endif
                            </td>
                            <td>
                                <form action="{{route("admin.telecalling.delete")}}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$telecalling->id}}"/>
