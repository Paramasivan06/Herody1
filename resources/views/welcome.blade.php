...
<head>
  ...
  <meta name="keywords" content="Gigs, Projects, Internships, Herody, Businesses, Gigworkers,Student Ambassador, Campus Ambassador, Online Reputation Management,Acquire Users,Social Media Promotion,GenZ Student Network,Lead Generation,Performance Reviews,WhatsApp Marketing,Attendee Acquisition, Data Moderation, Content Moderation,Telecalling  ">
...
.dropdown:hover .dropbtn {background-color: ##2667ff;}
/* .slider{
	height: 250px;
	margin: auto;
	position: relative;
