...
<body>
                ...
                <div class="header-left">
                    ...
                    <nav class="nav-menu d-none d-xl-block">
                        <ul class="primary-menu">
                            ...
                            <li>
                                <a class="active" href="https://herody.in/gigworkers">Gigworkers</a>
    ...
    <section class="page-title-area">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h2 class="page-title">Gigworkers</h2>
                </div>
                <div class="col-md-6">
    ...
    <!--====== About Area Start ======-->
    <section class="about-section section-gap overflow-hidden">
        <div class="custom-container-fluid">
            <div class="row align-items-center justify-content-xl-start justify-content-center">
                <div class="col-xl-4 col-lg-8 col-sm-10">
                    <div class="about-contant content-mb-lg-80">
                        <div class="section-heading mb-20">
                            <h2 class="title">Download the Herody App Now! </h2>
                            <span class="tagline">Start your Journey of Earning Money</span>
                        </div>
                        
                        <ul class="circle-list mb-40 mt-30 wow fadeInUp">
                            <li>Work From Home</li>
                            <li>Earn Money</li>
                            <li>Get Certified</li>
                            <li>Develop Skills</li>
                            <li>Become a Part of the Revolution</li>
                        </ul>
                         </div>
                </div>
                <div class="col-xl-6 offset-xl-1 col-lg-10 col-md-10">
                    <div class="fancy-image-gallery-two">
                        <div class="row align-items-center">
                            <div class="col-sm-6 wow fadeInUp">
                                <img width="500" height="250" class="mb-30" src="{{asset('assets/digital/assets/img/portfolio/03.jpg')}}" alt="About Image">
                            </div>
                            <div class="col-sm-6 wow fadeInUp">
                                <img width="500" height="250" class="mb-30" src="{{asset('assets/digital/assets/img/portfolio/25.jpg')}}" alt="About Image">
                            </div>
    ...
    <section class="call-to-action bg-color-secondary section-animate-icons">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-5 order-lg-last">
                    <div class="cta-illustrations text-center text-lg-right content-mb-md-50">
                        <img src="{{asset('assets/digital/assets/img/cta-illustrations.png')}}" alt="Image" class="animate-float-bob-y">
                    </div>
                </div>
                <div class="col-lg-7 col-md-10">
                    <div class="cta-content">
                        <h2 class="title">Become a Part of this Exciting Journey! </h2>
                    
                        <p class="cta-note">Download the Herody App</p>
                        <p class="cta-note">Apply for Gigs and Projects on the App</p>
                            <p class="cta-note">Complete the Tasks & Earn Money</p>
                        <a href="https://play.google.com/store/apps/details?id=com.jaketa.herody" class="template-btn">Download Herody App <i class="fa-brands fa-google-play"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="animate-icons">
            <img src="{{asset('assets/digital/assets/img/shape/dots-circle.png')}}" alt="Icon" class="dots-circle">
        </div>
        <div class="cta-shape">
