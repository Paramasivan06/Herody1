                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg mb-3" name="account_status"
                                                   >
                                                   <option value="1" <?php if ($userById->account_status=='1'){ echo 'selected'; } ?>>Active</option>
                                                   <option value="0" <?php if ($userById->account_status=='0'){ echo 'selected'; } ?>>Inactive</option>
                                                </select>
                                        </div>
                                    </div>
