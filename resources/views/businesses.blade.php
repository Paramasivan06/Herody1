                ...
                <div class="header-left">
                    ...
                    <nav class="nav-menu d-none d-xl-block">
                        <ul class="primary-menu">
                            ...
                            <li>
                                <a class="active" href="https://herody.in/businesses">Businesses</a>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="feature-img text-lg-left text-center content-mb-md-50">
                        <img src="{{asset('assets/digital/assets/img/illustrations/feature-illustration-02.png')}}" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6 col-md-10">
                    <div class="feature-text-block content-l-spacing">
                        <div class="section-heading mb-30">
                             <span class="tagline">We help businesses to scale by breaking down complex requirements as tasks and do end-to-end execution</span>
                        </div>
                        <div class="feature-lists">
                            <div class="simple-icon-box icon-left mb-30">
                                ...
                                <div class="content">
                                    <h4 class="title">PAN India Coverage</h4>
                                                                  </div>
                            </div>
                            <div class="simple-icon-box icon-left mb-30">
                                <div class="icon">
                                ...
                                <div class="content">
                                    <h4 class="title">Pay Per Outcome Model</h4>
                                    </div>
                            </div>
                            <div class="simple-icon-box icon-left mb-30">
                                <div class="icon">
                                ...
                                <div class="content">
                                    <h4 class="title">Execute On-Demand Projects</h4>
                                    </div>
                            </div>
                        </div>
                           </div>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-7 col-md-10">
                    <div class="cta-content">
                        <h2 class="title">Do you have any other business requirements?</h2>
                        <p class="subtitle">Let us know</p>

                        <p class="cta-note">Scale your business with us</p>
                        <a href="{{ route('bform') }}" class="template-btn" >
  Fill the Form <i class="fa-solid fa-long-arrow-right"></i>
</a>
                ...
                <div id="about" class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="widget newsletters-widget pl-xl-4">
                            ...
                            <p>
                                For any business releated queries reach us out at <strong><a class="info-title" href="raj@herody.in">raj@herody.in</a></strong>
                            </p>
